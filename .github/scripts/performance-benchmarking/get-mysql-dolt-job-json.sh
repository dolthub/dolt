        ...
        "containers": [
          {
            ...
            "args": [
              ...
              "--withTpcc=true",
              "--sysbenchQueries='"$medianLatencyMultiplierReadsQuery"' '"$meanMultiplierReadsQuery"' '"$medianLatencyMultiplierWritesQuery"' '"$meanMultiplierWritesQuery"' '"$meanMultiplierOverallQuery"'",
              "--tpccQueries='"$tpccMedianLatencyMultiplierReadsQuery"' '"$tpccMeanMultiplierReadsQuery"' '"$tpccMedianLatencyMultiplierWritesQuery"' '"$tpccMeanMultiplierWritesQuery"' '"$tpccMeanMultiplierOverallQuery"'"
            ]
          }
        ],
        "restartPolicy": "Never",
