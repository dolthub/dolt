...
import (
	"errors"
	"github.com/attic-labs/noms/Godeps/_workspace/src/github.com/mikkyang/id3-go/v1"
	"github.com/attic-labs/noms/Godeps/_workspace/src/github.com/mikkyang/id3-go/v2"
	"os"
)
