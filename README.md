...
* Learn the core tools: [`server`](clients/server), [`splore`](clients/splore), [`shove`](clients/shove), [`csv/importer`](clients/csv/importer), [`json_importer`](clients/json_importer), [`xml_importer`](clients/xml_importer)
