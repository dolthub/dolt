...
@test "two branches change type of same column to same type. merge. no conflict" {
    ...
    dolt table create -f -s=`nativebatsdir helper/1pk5col-ints-change-type-1.schema` test
    dolt add test
...
@test "two branches change type of same column to different type. merge. conflict" {
    ...
    dolt commit -m "changed c1 to type bool"
    dolt checkout change-types
    dolt table create -f -s=`nativebatsdir helper/1pk5col-ints-change-type-2.schema` test
    dolt add test
...
@test "two branches make same column primary key. merge. no conflict" {
    ...
    dolt commit -m "table created"
    dolt branch add-pk
    dolt table create -f -s=`nativebatsdir helper/1pk5col-ints-change-pk-1.schema` test
    dolt add test
...
@test "two branches add same primary key column. merge. no conflict" {
    ...
    dolt commit -m "table created"
    dolt branch add-pk
    dolt table create -f -s=`nativebatsdir helper/1pk5col-ints-add-pk1.schema` test
    dolt add test
...
@test "two branches make different columns primary key. merge. conflict" {
    ...
    dolt commit -m "added pk pk1"
    dolt checkout add-pk
    dolt table create -f -s=`nativebatsdir helper/1pk5col-ints-add-pk2.schema` test
    dolt add test
...
@test "two branches both create different tables. merge. no conflict" {
    ...
    dolt table create -s=`nativebatsdir helper/1pk5col-ints.schema` table1
    dolt add table1
    dolt commit -m "first table"
    dolt checkout table2
    dolt table create -s=`nativebatsdir helper/2pk5col-ints.schema` table2
    dolt add table2
