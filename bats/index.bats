...
SQL
    ...
    run dolt index cat onepk idx_v1
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v1 | pk1 |" ]] || false
    [[ "${lines[3]}" = "| 11 | 2   |" ]] || false
    [[ "${lines[4]}" = "| 22 | 4   |" ]] || false
    [[ "${lines[5]}" = "| 77 | 5   |" ]] || false
    [[ "${lines[6]}" = "| 88 | 3   |" ]] || false
    ...
    run dolt sql -q "SELECT pk1 FROM onepk WHERE v1 = 77"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 |" ]] || false
    [[ "${lines[3]}" = "| 5   |" ]] || false
    [[ "${lines[4]}" = "+-----+" ]] || false
...
SQL
    ...
    run dolt index cat twopk idx_v
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v2 | v1 | pk1 | pk2 |" ]] || false
    [[ "${lines[3]}" = "| 61 | 52 | 3   | 88  |" ]] || false
    [[ "${lines[4]}" = "| 61 | 53 | 5   | 77  |" ]] || false
    [[ "${lines[5]}" = "| 63 | 51 | 1   | 99  |" ]] || false
    [[ "${lines[6]}" = "| 64 | 55 | 2   | 11  |" ]] || false
    [[ "${lines[7]}" = "| 65 | 54 | 4   | 22  |" ]] || false
    [[ "${lines[8]}" = "+----+----+-----+-----+" ]] || false
    run dolt schema show twopk
    [ "$status" -eq "0" ]
    [[ "$output" =~ 'INDEX `idx_v` (`v2`,`v1`)' ]] || false
    run dolt sql -q "SELECT pk1, pk2 FROM twopk WHERE v2 = 61 AND v1 = 53"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77  |" ]] || false
    [[ "${lines[4]}" = "+-----+-----+" ]] || false
}
...
SQL
    ...
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" =  "| v2  | v1 | pk1 | pk2 |" ]] || false
    [[ "${lines[3]}" =  "| -59 | 13 | 6   | 77  |" ]] || false
    [[ "${lines[4]}" =  "| 60  | 59 | 3   | 87  |" ]] || false
    [[ "${lines[5]}" =  "| 61  | 52 | 3   | 88  |" ]] || false
    [[ "${lines[6]}" =  "| 61  | 53 | 5   | 77  |" ]] || false
    [[ "${lines[7]}" =  "| 63  | -1 | 1   | 99  |" ]] || false
    [[ "${lines[8]}" =  "| 64  | 55 | 2   | 11  |" ]] || false
    [[ "${lines[9]}" =  "| 65  | -4 | 4   | 102 |" ]] || false
    [[ "${lines[10]}" = "| 65  | 54 | 4   | 22  |" ]] || false
    [[ "${lines[11]}" = "+-----+----+-----+-----+" ]] || false
    run dolt sql -q "SELECT pk1, pk2 FROM twopk WHERE v2 = 61 AND v1 = 53"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 |" ]] || false
...
SQL
    ...
    [[ "${lines[7]}" = "| 99 | 1   |" ]] || false
    [[ "${lines[8]}" = "+----+-----+" ]] || false
    run dolt sql -q "SELECT pk1 FROM onepk WHERE v1 = 76"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 |" ]] || false
    [[ "${lines[3]}" = "| 5   |" ]] || false
    [[ "${lines[4]}" = "+-----+" ]] || false
...
SQL
    ...
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v2 | v1 | pk1 | pk2 |" ]] || false
    [[ "${lines[3]}" = "| 5  | 56 | 3   | 88  |" ]] || false
    [[ "${lines[4]}" = "| 5  | 59 | 2   | 11  |" ]] || false
    [[ "${lines[5]}" = "| 8  | 55 | 1   | 99  |" ]] || false
    [[ "${lines[6]}" = "| 61 | 53 | 5   | 77  |" ]] || false
    [[ "${lines[7]}" = "| 65 | 54 | 4   | 22  |" ]] || false
    [[ "${lines[8]}" = "+----+----+-----+-----+" ]] || false
    run dolt sql -q "SELECT pk1, pk2 FROM twopk WHERE v2 = 5 AND v1 = 56"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 |" ]] || false
    [[ "${lines[3]}" = "| 3   | 88  |" ]] || false
    [[ "${lines[4]}" = "+-----+-----+" ]] || false
...
SQL
    ...
    [[ "${lines[3]}" = "| 5   |" ]] || false
    [[ "${lines[4]}" = "+-----+" ]] || false
    run dolt sql -q "SELECT pk1 FROM onepk WHERE v1 = 88"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 |" ]] || false
    [[ "${lines[3]}" = "+-----+" ]] || false
...
SQL
    ...
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v2 | v1 | pk1 | pk2 |" ]] || false
    [[ "${lines[3]}" = "| 63 | 51 | 1   | 99  |" ]] || false
    [[ "${lines[4]}" = "| 65 | 54 | 4   | 22  |" ]] || false
    [[ "${lines[5]}" = "+----+----+-----+-----+" ]] || false
    run dolt sql -q "SELECT pk1, pk2 FROM twopk WHERE v2 = 65 AND v1 = 54"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 |" ]] || false
    [[ "${lines[3]}" = "| 4   | 22  |" ]] || false
    [[ "${lines[4]}" = "+-----+-----+" ]] || false
    run dolt sql -q "SELECT pk1, pk2 FROM twopk WHERE v2 = 61 AND v1 = 52"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+" ]] || false
}
...
SQL
    ...
    [[ "$output" =~ 'INDEX `idx_v1` (`v1`)' ]] || false
    [[ "$output" =~ 'INDEX `idx_v1v2` (`v1`,`v2`)' ]] || false
    run dolt index cat newpk idx_v1
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v1 | pk1 |" ]] || false
    [[ "${lines[3]}" = "| 11 | 2   |" ]] || false
    [[ "${lines[4]}" = "| 22 | 4   |" ]] || false
    ...
    [[ "${lines[7]}" = "| 99 | 1   |" ]] || false
    [[ "${lines[8]}" = "+----+-----+" ]] || false
    run dolt index cat newpk idx_v1v2
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v1 | v2 | pk1 |" ]] || false
    [[ "${lines[3]}" = "| 11 | 55 | 2   |" ]] || false
    [[ "${lines[4]}" = "| 22 | 54 | 4   |" ]] || false
    [[ "${lines[5]}" = "| 77 | 53 | 5   |" ]] || false
    [[ "${lines[6]}" = "| 88 | 52 | 3   |" ]] || false
    [[ "${lines[7]}" = "| 99 | 51 | 1   |" ]] || false
    [[ "${lines[8]}" = "+----+----+-----+" ]] || false
    run dolt sql -q "SELECT pk1 FROM newpk WHERE v1 = 77"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 |" ]] || false
    [[ "${lines[3]}" = "| 5   |" ]] || false
    [[ "${lines[4]}" = "+-----+" ]] || false
    run dolt sql -q "SELECT pk1 FROM newpk WHERE v1 = 88 AND v2 = 52"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 |" ]] || false
    [[ "${lines[3]}" = "| 3   |" ]] || false
    [[ "${lines[4]}" = "+-----+" ]] || false
...
SQL
    ...
    [ "$status" -eq "0" ]
    [[ "$output" =~ "idx_v1(v1)" ]] || false
    run dolt index cat onepk_new idx_v1
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v1 | pk1 |" ]] || false
    [[ "${lines[3]}" = "| 11 | 2   |" ]] || false
    [[ "${lines[4]}" = "| 22 | 4   |" ]] || false
    ...
    [ "$status" -eq "0" ]
    [[ "$output" =~ 'INDEX `idx_v1` (`v1`)' ]] || false
    run dolt sql -q "SELECT pk1 FROM onepk_new WHERE v1 = 77"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 |" ]] || false
    [[ "${lines[3]}" = "| 5   |" ]] || false
    [[ "${lines[4]}" = "+-----+" ]] || false
...
SQL
    ...
    run dolt sql -q "SELECT * FROM onepk WHERE v1 = 77"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77 | 53 |" ]] || false
    [[ "${lines[4]}" = "+-----+----+----+" ]] || false
    # not found
    run dolt sql -q "SELECT * FROM onepk WHERE v1 = 111"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+----+----+" ]] || false
    # not indexed & found
    run dolt sql -q "SELECT * FROM onepk WHERE v2 = 54"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 4   | 22 | 54 |" ]] || false
    [[ "${lines[4]}" = "+-----+----+----+" ]] || false
    # not indexed & not found
    run dolt sql -q "SELECT * FROM onepk WHERE v2 = 111"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+----+----+" ]] || false
    # found
    run dolt sql -q "SELECT * FROM twopk WHERE v2 = 61 AND v1 = 53"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77  | 53 | 61 |" ]] || false
    [[ "${lines[4]}" = "+-----+-----+----+----+" ]] || false
    # not found key 1
    run dolt sql -q "SELECT * FROM twopk WHERE v2 = 111 AND v1 = 53"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not found key 2
    run dolt sql -q "SELECT * FROM twopk WHERE v2 = 61 AND v1 = 111"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not found key mismatch
    run dolt sql -q "SELECT * FROM twopk WHERE v2 = 61 AND v1 = 54"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not indexed & found
    run dolt sql -q "SELECT * FROM twopk WHERE v1 = 53"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77  | 53 | 61 |" ]] || false
    [[ "${lines[4]}" = "+-----+-----+----+----+" ]] || false
    # not indexed & not found
    run dolt sql -q "SELECT * FROM twopk WHERE v1 = 111"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
}
...
@test "index: SELECT > Full Match" {
    skip "comparison does not yet use indexing"
    dolt sql <<SQL
CREATE INDEX idx_v1 ON onepk(v1);
CREATE INDEX idx_v ON twopk(v2, v1);
INSERT INTO onepk VALUES (1, 99, 51), (2, 11, 55), (3, 88, 52), (4, 22, 54), (5, 77, 53);
...
SQL
    # found
    run dolt sql -q "SELECT * FROM onepk WHERE v1 > 70"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77 | 53 |" ]] || false
    [[ "${lines[4]}" = "| 3   | 88 | 52 |" ]] || false
    [[ "${lines[5]}" = "| 1   | 99 | 51 |" ]] || false
    [[ "${lines[6]}" = "+-----+----+----+" ]] || false
    # not found
    run dolt sql -q "SELECT * FROM onepk WHERE v1 > 111"
    [ "$status" -eq "0" ]
    ...
    [[ "${lines[3]}" = "+-----+----+----+" ]] || false
    # not indexed & found
    run dolt sql -q "SELECT * FROM onepk WHERE v2 > 53"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 2   | 11 | 55 |" ]] || false
    [[ "${lines[4]}" = "| 4   | 22 | 54 |" ]] || false
    [[ "${lines[5]}" = "+-----+----+----+" ]] || false
    # not indexed & not found
    run dolt sql -q "SELECT * FROM onepk WHERE v2 > 111"
    [ "$status" -eq "0" ]
    ...
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 2   | 11  | 55 | 64 |" ]] || false
    [[ "${lines[4]}" = "| 4   | 22  | 54 | 65 |" ]] || false
    [[ "${lines[5]}" = "+-----+-----+----+----+" ]] || false
    # not found key 1
    run dolt sql -q "SELECT * FROM twopk WHERE v2 > 111 AND v1 > 53"
    [ "$status" -eq "0" ]
    ...
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not found key mismatch
    run dolt sql -q "SELECT * FROM twopk WHERE v2 > 64 AND v1 > 54"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not indexed & found
...
SQL
    # found
    run dolt sql -q "SELECT * FROM onepk WHERE v1 < 99"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 2   | 11 | 55 |" ]] || false
    [[ "${lines[4]}" = "| 4   | 22 | 54 |" ]] || false
    [[ "${lines[5]}" = "| 5   | 77 | 53 |" ]] || false
    [[ "${lines[6]}" = "| 3   | 88 | 52 |" ]] || false
    [[ "${lines[7]}" = "+-----+----+----+" ]] || false
    # not found
    run dolt sql -q "SELECT * FROM onepk WHERE v1 < 0"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+----+----+" ]] || false
    # not indexed & found
    ...
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 1   | 99 | 51 |" ]] || false
    [[ "${lines[4]}" = "| 3   | 88 | 52 |" ]] || false
    [[ "${lines[5]}" = "+-----+----+----+" ]] || false
    # not indexed & not found
    run dolt sql -q "SELECT * FROM onepk WHERE v2 < 0"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+----+----+" ]] || false
    # found
    run dolt sql -q "SELECT * FROM twopk WHERE v2 < 64 AND v1 < 53"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 3   | 88  | 52 | 61 |" ]] || false
    [[ "${lines[4]}" = "| 1   | 99  | 51 | 63 |" ]] || false
    [[ "${lines[5]}" = "+-----+-----+----+----+" ]] || false
    # not found key 1
    run dolt sql -q "SELECT * FROM twopk WHERE v2 < 0 AND v1 < 53"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not found key 2
    run dolt sql -q "SELECT * FROM twopk WHERE v2 < 61 AND v1 < 0"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not found key mismatch
    run dolt sql -q "SELECT * FROM twopk WHERE v2 < 62 AND v1 < 52"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not indexed & found
    ...
    [[ "${lines[5]}" = "+-----+-----+----+----+" ]] || false
    # not indexed & not found
    run dolt sql -q "SELECT * FROM twopk WHERE v1 < 0"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
}
...
SQL
    ...
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77  | 53 | 61 |" ]] || false
    [[ "${lines[4]}" = "| 2   | 11  | 55 | 64 |" ]] || false
    [[ "${lines[5]}" = "| 4   | 22  | 54 | 65 |" ]] || false
    [[ "${lines[6]}" = "+-----+-----+----+----+" ]] || false
    # not found key 1
    run dolt sql -q "SELECT * FROM twopk WHERE v2 >= 111 AND v1 >= 53"
    [ "$status" -eq "0" ]
    ...
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not found key mismatch
    run dolt sql -q "SELECT * FROM twopk WHERE v2 >= 65 AND v1 >= 55"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not indexed & found
...
SQL
    ...
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 3   | 88  | 52 | 61 |" ]] || false
    [[ "${lines[4]}" = "| 5   | 77  | 53 | 61 |" ]] || false
    [[ "${lines[5]}" = "| 1   | 99  | 51 | 63 |" ]] || false
    [[ "${lines[6]}" = "+-----+-----+----+----+" ]] || false
    # not found key 1
    run dolt sql -q "SELECT * FROM twopk WHERE v2 <= 0 AND v1 <= 53"
    [ "$status" -eq "0" ]
    ...
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not found key mismatch
    run dolt sql -q "SELECT * FROM twopk WHERE v2 <= 61 AND v1 <= 51"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "+-----+-----+----+----+" ]] || false
    # not indexed & found
...
SQL
    ...
    run dolt sql -q "SELECT * FROM onepk WHERE v1 = 77"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 | v3     |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77 | 53 | <NULL> |" ]] || false
    [[ "${lines[4]}" = "+-----+----+----+--------+" ]] || false
    ...
    run dolt sql -q "SELECT * FROM twopk WHERE v2 = 61 AND v1 = 53"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | pk2 | v1 | v2 | v3 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77  | 53 | 61 | 7  |" ]] || false
    [[ "${lines[4]}" = "+-----+-----+----+----+----+" ]] || false
}
...
SQL
    ...
    [[ "${lines[7]}" = "| 99   | 1   |" ]] || false
    [[ "${lines[8]}" = "+------+-----+" ]] || false
    run dolt index cat onepk_new idx_v2v1
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v2 | vnew | pk1 |" ]] || false
    [[ "${lines[3]}" = "| 51 | 99   | 1   |" ]] || false
    [[ "${lines[4]}" = "| 52 | 88   | 3   |" ]] || false
    [[ "${lines[5]}" = "| 53 | 77   | 5   |" ]] || false
    [[ "${lines[6]}" = "| 54 | 22   | 4   |" ]] || false
    [[ "${lines[7]}" = "| 55 | 11   | 2   |" ]] || false
    [[ "${lines[8]}" = "+----+------+-----+" ]] || false
    run dolt schema show onepk_new
    [ "$status" -eq "0" ]
    [[ "$output" =~ 'INDEX `idx_v1` (`vnew`)' ]] || false
    [[ "$output" =~ 'INDEX `idx_v2v1` (`v2`,`vnew`)' ]] || false
    run dolt sql -q "SELECT * FROM onepk_new WHERE vnew = 77"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | vnew | v2 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77   | 53 |" ]] || false
    [[ "${lines[4]}" = "+-----+------+----+" ]] || false
}

@test "index: ALTER TABLE MODIFY COLUMN NULL" {
    skip "we show an error that v1 already exists, which should not happen for a modify column"
    dolt sql <<SQL
CREATE TABLE onepk_new (
  pk1 BIGINT PRIMARY KEY,
  v1 BIGINT NOT NULL,
...
SQL
    ...
    [[ "$output" =~ 'INDEX `idx_v1` (`v1`)' ]] || false
    [[ "$output" =~ 'INDEX `idx_v2v1` (`v2`,`v1`)' ]] || false
    run dolt sql -q "SELECT * FROM onepk_new WHERE v1 = 77"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77 | 53 |" ]] || false
    [[ "${lines[4]}" = "+-----+----+----+" ]] || false
...
SQL
    ...
    [[ "${lines[7]}" = "| 99   | 1   |" ]] || false
    [[ "${lines[8]}" = "+------+-----+" ]] || false
    run dolt index cat onepk idx_v2v1
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v2 | vnew | pk1 |" ]] || false
    [[ "${lines[3]}" = "| 51 | 99   | 1   |" ]] || false
    [[ "${lines[4]}" = "| 52 | 88   | 3   |" ]] || false
    ...
    [[ "$output" =~ 'INDEX `idx_v1` (`vnew`)' ]] || false
    [[ "$output" =~ 'INDEX `idx_v2v1` (`v2`,`vnew`)' ]] || false
    run dolt sql -q "SELECT * FROM onepk WHERE vnew = 77"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | vnew | v2 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 77   | 53 |" ]] || false
    [[ "${lines[4]}" = "+-----+------+----+" ]] || false
...
SQL
    ...
    ! [[ "$output" =~ 'INDEX `idx_v2v1` (`v2`,`v1`)' ]] || false
    ! [[ "$output" =~ 'INDEX `idx_v1v2` (`v1`,`v2`)' ]] || false
    run dolt index cat onepk idx_v2
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v2 | pk1 |" ]] || false
    [[ "${lines[3]}" = "| 51 | 1   |" ]] || false
    [[ "${lines[4]}" = "| 52 | 3   |" ]] || false
    [[ "${lines[5]}" = "| 53 | 5   |" ]] || false
    [[ "${lines[6]}" = "| 54 | 4   |" ]] || false
    ...
    run dolt sql -q "SELECT * FROM onepk WHERE v2 = 53"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v2 |" ]] || false
    [[ "${lines[3]}" = "| 5   | 53 |" ]] || false
    [[ "${lines[4]}" = "+-----+----+" ]] || false
}

@test "index: Retag column CHANGE COLUMN" {
    dolt sql <<SQL
CREATE INDEX idx_v1 ON onepk(v1);
CREATE INDEX idx_v2v1 ON onepk(v2,v1);
INSERT INTO onepk VALUES (1, 99, 51), (2, 11, 55), (3, 88, 52), (4, 22, 54), (5, 77, 53);
ALTER TABLE onepk CHANGE COLUMN v1 vnew BIGINT COMMENT 'tag:9999';
SQL
    run dolt index cat onepk idx_v1
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| vnew | pk1 |" ]] || false
...
@test "index: Retag column MODIFY COLUMN" {
    skip "we show an error that v1 already exists, which should not happen for a modify column"
    dolt sql <<SQL
CREATE INDEX idx_v1 ON onepk(v1);
CREATE INDEX idx_v2v1 ON onepk(v2,v1);
INSERT INTO onepk VALUES (1, 99, 51), (2, 11, 55), (3, 88, 52), (4, 22, 54), (5, 77, 53);
ALTER TABLE onepk MODIFY COLUMN v1 BIGINT COMMENT 'tag:9999';
SQL
    run dolt index cat onepk idx_v1
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| v1 | pk1 |" ]] || false
...
@test "index: Merge without conflicts" {
    ...
    [ "$status" -eq "0" ]
    [[ "$output" =~ 'INDEX `idx_v1` (`v1`)' ]] || false
    run dolt sql -q "SELECT * FROM onepk WHERE v1 = 55"
    [ "$status" -eq "0" ]
    [[ "${lines[1]}" = "| pk1 | v1 | v2  |" ]] || false
    [[ "${lines[3]}" = "| 5   | 55 | 505 |" ]] || false
    [[ "${lines[4]}" = "+-----+----+-----+" ]] || false
}
