	...
	p := types.NewPackage([]types.Type{
		...
		types.MakeStructType("Quarter",
			[]types.Field{
				...
				types.Field{"Quarter", types.MakeType(ref.Ref{}, 2), false},
			},
			types.Choices{},
		),
		types.MakeStructType("Key",
			...
			types.Choices{
				types.Field{"Year", types.MakePrimitiveType(types.Int32Kind), false},
				types.Field{"Quarter", types.MakeType(ref.Ref{}, 3), false},
...
func init() {
	__typeForQuarterEnum = types.MakeType(__mainPackageInFile_crunchbase_CachedRef, 2)
...
func init() {
	__typeForQuarter = types.MakeType(__mainPackageInFile_crunchbase_CachedRef, 3)
...
func init() {
	__typeForKey = types.MakeType(__mainPackageInFile_crunchbase_CachedRef, 4)
...
func init() {
	__typeForMapOfRefOfKeyToSetOfRefOfRound = types.MakeCompoundType(types.MapKind, types.MakeCompoundType(types.RefKind, types.MakeType(__mainPackageInFile_crunchbase_CachedRef, 4)), types.MakeCompoundType(types.SetKind, types.MakeCompoundType(types.RefKind, types.MakeType(__mainPackageInFile_crunchbase_CachedRef, 1))))
...
func init() {
	__typeForRefOfKey = types.MakeCompoundType(types.RefKind, types.MakeType(__mainPackageInFile_crunchbase_CachedRef, 4))
