...
func init() {
	__typeForAlbum = types.MakeType(__mainPackageInFile_facebook_CachedRef, 1)
...
func init() {
	__typeForMapOfStringToAlbum = types.MakeCompoundType(types.MapKind, types.MakePrimitiveType(types.StringKind), types.MakeType(__mainPackageInFile_facebook_CachedRef, 1))
...
func init() {
	__typeForSetOfRemotePhoto = types.MakeCompoundType(types.SetKind, types.MakeType(ref.Parse("sha1-42722c55cec055ff32526d1dc0636fa4d48c9fd5"), 0))
