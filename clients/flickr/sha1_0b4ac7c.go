...
var __mainPackageInFile_sha1_0b4ac7c_CachedRef ref.Ref
...
func init() {
	...
	__mainPackageInFile_sha1_0b4ac7c_CachedRef = types.RegisterPackage(&p)
}
...
func init() {
	__typeForDate = types.MakeType(__mainPackageInFile_sha1_0b4ac7c_CachedRef, 0)
