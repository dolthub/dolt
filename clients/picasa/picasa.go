...
var (
	apiKeyUsage = `To create Google API credentials, follow these steps:
	...
	apiKeyFlag       = flag.String("api-key", "", apiKeyUsage)
	apiKeySecretFlag = flag.String("api-key-secret", "", "See -api-key for help creating an api-key-secret")
