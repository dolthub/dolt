...
var __mainPackageInFile_sha1_5226f8e_CachedRef ref.Ref
...
func init() {
	...
	__mainPackageInFile_sha1_5226f8e_CachedRef = types.RegisterPackage(&p)
}
...
func init() {
	__typeForRemotePhoto = types.MakeType(__mainPackageInFile_sha1_5226f8e_CachedRef, 0)
...
func init() {
	__typeForFace = types.MakeType(__mainPackageInFile_sha1_5226f8e_CachedRef, 1)
...
func init() {
	__typeForSize = types.MakeType(__mainPackageInFile_sha1_5226f8e_CachedRef, 2)
...
func init() {
	__typeForMapOfSizeToString = types.MakeCompoundType(types.MapKind, types.MakeType(__mainPackageInFile_sha1_5226f8e_CachedRef, 2), types.MakePrimitiveType(types.StringKind))
...
func init() {
	__typeForSetOfFace = types.MakeCompoundType(types.SetKind, types.MakeType(__mainPackageInFile_sha1_5226f8e_CachedRef, 1))
