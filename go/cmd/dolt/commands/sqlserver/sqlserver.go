...
func (cmd SqlServerCmd) ArgParser() *argparser.ArgParser {
	...
	ap.SupportsString(allowCleartextPasswordsFlag, "", "allow-cleartext-passwords", "Allows use of cleartext passwords (default false).")
	ap.SupportsString(socketFlag, "", "socket file", "Path for the unix socket file (default '/tmp/mysql.sock').")
	return ap
}
