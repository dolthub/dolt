...
func (rcv *TupleMap) RefCardinality(j int) uint64 {
...
func (rcv *TupleMap) RefCardinalityLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(14))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
func (rcv *TupleMap) MutateRefCardinality(j int, n uint64) bool {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(14))
	if o != 0 {
		a := rcv._tab.Vector(o)
...
func TupleMapAddRefCardinality(builder *flatbuffers.Builder, refCardinality flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(refCardinality), 0)
}
func TupleMapStartRefCardinalityVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
