...
const (
	ClientEventsService_LogEvents_FullMethodName = "/dolt.services.eventsapi.v1alpha1.ClientEventsService/LogEvents"
)
...
func (c *clientEventsServiceClient) LogEvents(ctx context.Context, in *LogEventsRequest, opts ...grpc.CallOption) (*LogEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClientEventsService_LogEvents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedClientEventsServiceServer must be embedded to have
...
func (UnimplementedClientEventsServiceServer) testEmbeddedByValue()                             {}
...
func RegisterClientEventsServiceServer(s grpc.ServiceRegistrar, srv ClientEventsServiceServer) {
	// If the following call panics, it indicates UnimplementedClientEventsServiceServer was
...
func _ClientEventsService_LogEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClientEventsService_LogEvents_FullMethodName,
	}
