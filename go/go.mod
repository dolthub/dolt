...
require (
	...
	github.com/dolthub/go-mysql-server v0.9.1-0.20210506141947-b3061a6fb867
...
replace github.com/dolthub/go-mysql-server => /Users/vinairachakonda/Desktop/go-mysql-server-dup
