...
require (
	...
	github.com/liquidata-inc/sqllogictest/go v0.0.0-20191018203759-b07d72147b81
...
replace github.com/src-d/go-mysql-server => github.com/liquidata-inc/go-mysql-server v0.4.1-0.20191003230430-3a1a09c79ada
