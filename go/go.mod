...
require (
	...
	github.com/liquidata-inc/sqllogictest/go v0.0.0-20191024183358-3acbd5214797
...
replace github.com/src-d/go-mysql-server => github.com/liquidata-inc/go-mysql-server v0.4.1-0.20191108165608-d1ae6a2391d0
