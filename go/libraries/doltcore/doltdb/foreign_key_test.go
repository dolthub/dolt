		...
		fks: []doltdb.ForeignKey{
			{
				...
				ReferencedTableColumnNames: []string{"v1"},
			},
		},
	},
	{
		...
		fks: []doltdb.ForeignKey{
			{
				...
				ReferencedTableColumnNames: []string{"v1", "v2"},
			},
		},
	},
	{
		...
		fks: []doltdb.ForeignKey{
			...
			},
			{
				...
				ReferencedTableColumnNames: []string{"v2"},
			},
		},
	},
	{
	...
	},
	{
		...
		fks: []doltdb.ForeignKey{
			...
			},
			{
				...
				ReferencedTableColumnNames: []string{"v3"},
				OnUpdate:                   doltdb.ForeignKeyReferenceOption_Cascade,
				OnDelete:                   doltdb.ForeignKeyReferenceOption_Cascade,
			},
			{
				...
				ReferencedTableColumnNames: []string{"v4"},
			...
			},
			{
				...
				ReferencedTableColumnNames: []string{"v5"},
