...
const (
	...
	// UnquotedIdentifierRegexStr is the regular expression that valid identifiers must match.
	// https://dev.mysql.com/doc/refman/8.0/en/identifiers.html
	// TODO: move this to the engine
	UnquotedIdentifierRegexStr = `^[a-zA-Z$_]+[0-9a-zA-Z$_]*$|^[0-9a-zA-Z$_]*[a-zA-Z$_]+$`
)

var (
	unquotedIdentifierRegex = regexp.MustCompile(UnquotedIdentifierRegexStr)
...
// IsValidIdentifier returns true if the name matches the regular expression UnquotedIdentifierRegexStr.
// Table names must be composed of 1 or more letters and non-initial numerals, as well as the characters _ and -
func IsValidIdentifier(name string) bool {
	return unquotedIdentifierRegex.MatchString(name)
}
