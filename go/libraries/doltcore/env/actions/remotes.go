...
// source db.
func Push(ctx context.Context, dEnv *env.DoltEnv, destRef ref.BranchRef, remoteRef ref.RemoteRef, srcDB, destDB *doltdb.DoltDB, commit *doltdb.Commit, progChan chan datas.PullProgress) error {
	...
	err = destDB.PushChunks(ctx, dEnv.TempTableFilesDir(), srcDB, commit, progChan)
...
func Fetch(ctx context.Context, dEnv *env.DoltEnv, destRef ref.DoltRef, srcDB, destDB *doltdb.DoltDB, commit *doltdb.Commit, progChan chan datas.PullProgress) error {
	err := destDB.PullChunks(ctx, dEnv.TempTableFilesDir(), srcDB, commit, progChan)
