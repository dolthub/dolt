...
var RebaseTagTests = []RebaseTagTest{
	{
		...
		Commands: []tc.Command{
			tc.Query{createPeopleTable},
			tc.Commit{"made changes"},
		},
		OldTag:         DripTag,
	...
	},
	{
		...
		Commands: []tc.Command{
			tc.Query{createPeopleTable},
			tc.Query{`alter table people add drip double comment 'tag:` + strconv.Itoa(DripTag) + `';`},
			tc.Query{`insert into people (id, name, age, drip) values
	...
	},
	{
		...
		Commands: []tc.Command{
			tc.Query{createPeopleTable},
			tc.Query{`insert into people (id, name, age) values (9, "Jacqueline Bouvier", 80);`},
			tc.Commit{"made changes"},
			tc.Query{`alter table people add drip double comment 'tag:` + strconv.Itoa(DripTag) + `';`},
			tc.Query{`insert into people (id, name, age, drip) values (11, "Selma Bouvier", 40, 8.5);`},
			tc.Commit{"made changes"},
		},
		OldTag:            DripTag,
		NewTag:            DripTagRebased,
	...
	},
	{
		...
		Commands: []tc.Command{
			...
			tc.Commit{"made changes"},
			tc.Query{`alter table people add drip double comment 'tag:` + strconv.Itoa(DripTag) + `';`},
			tc.Query{`update people set drip=9.9 where id=9;`},
			tc.Commit{"made changes"},
		},
		OldTag:            DripTag,
		NewTag:            DripTagRebased,
	...
	},
	{
		...
		Commands: []tc.Command{
			...
			tc.Query{`insert into people (id, name, age, drip) values (11, "Selma Bouvier", 40, 8.5);`},
			tc.Commit{"made changes"},
			tc.Query{`update people set drip=9.9 where id=11;`},
			tc.Commit{"made changes"},
		},
		OldTag:            DripTag,
		NewTag:            DripTagRebased,
	...
	},
	{
		...
		Commands: []tc.Command{
			...
			tc.Commit{"made changes"},
			tc.Query{`update people set drip=9.9 where id=11;`},
			tc.Query{`update people set drip=1.1 where id=9;`},
			tc.Commit{"made changes"},
		},
		OldTag:            DripTag,
		NewTag:            DripTagRebased,
	...
	},
	{
		...
		Commands: []tc.Command{
			tc.Query{createPeopleTable},
			tc.Query{`insert into people (id, name, age) values 
				(7, "Maggie Simpson", 1),
				(8, "Milhouse Van Houten", 8);`},
			tc.Commit{"made changes"},
			tc.Query{`alter table people add drip double comment 'tag:` + strconv.Itoa(DripTag) + `';`},
			tc.Commit{"made changes"},
			tc.Query{`update people set age=2 where id=7;`},
			tc.Query{`delete from people where id=8;`},
			tc.Query{`insert into people (id, name, age) values (9, "Jacqueline Bouvier", 80);`},
			tc.Commit{"made changes"},
		},
		OldTag:            DripTag,
	...
	},
	{
		...
		Commands: []tc.Command{
			...
			tc.Branch{"newBranch"},
			tc.Query{`alter table people add drip double comment 'tag:` + strconv.Itoa(DripTag) + `';`},
			tc.Query{`delete from people where id=6;`},
			tc.Query{`update people set drip=99.9 where id=7;`},
			tc.Query{`insert into people (id, name, age, drip) values (11, "Selma Bouvier", 40, 8.5);`},
			tc.Commit{"made changes"},
			tc.Checkout{"newBranch"},
			tc.Query{`insert into people (id, name, age) values (10, "Patty Bouvier", 40);`},
			tc.Query{`delete from people where id=8;`},
			tc.Query{`update people set age=40 where id=9;`},
			tc.Commit{"made changes"},
			tc.Checkout{"master"},
			tc.Merge{"newBranch"},
			tc.Commit{"made changes"},
	...
	},
	{
		...
		Commands: []tc.Command{
			...
			tc.Commit{"made changes"},
			tc.Query{`alter table people add drip double comment 'tag:` + strconv.Itoa(DripTag) + `';`},
			tc.Query{`insert into people (id, name, age, drip) values (9, "Jacqueline Bouvier", 80, 8.5);`},
			tc.Commit{"made changes"},
			tc.Branch{"newBranch"},
			tc.Checkout{"newBranch"},
			tc.Query{`insert into people (id, name, age, drip) values (11, "Selma Bouvier", 40, 8.5);`},
			tc.Commit{"made changes"},
			tc.Checkout{"master"},
			tc.Query{`insert into people (id, name, age, drip) values (10, "Patty Bouvier", 40, 8.5);`},
			tc.Commit{"made changes"},
			tc.Merge{"newBranch"},
			tc.Commit{"made changes"},
		},
	...
	},
	{
		...
		Commands: []tc.Command{
			...
			tc.Query{`insert into people (id, name, age) values (9, "Jacqueline Bouvier", 80);`},
			tc.Commit{"made changes"},
			tc.Query{`delete from people where id=9;`},
			tc.Commit{"made changes"},
			tc.Query{`alter table people drop column drip;`},
			tc.Commit{"made changes"},
		},
		OldTag:            DripTag,
		NewTag:            DripTagRebased,
...
func testRebaseTagHistory(t *testing.T) {
	cmds := []tc.Command{
		...
		tc.Query{`insert into people (id, name, age) values 
			(7, "Maggie Simpson", 1);`},
		tc.Commit{"made changes"}, // common ancestor of (newMaster, oldMaster) and (newMaster, other)

		tc.Query{`alter table people add drip double comment 'tag:` + strconv.Itoa(DripTag) + `';`},
		tc.Commit{"made changes"}, // common ancestor of (oldMaster, other)
