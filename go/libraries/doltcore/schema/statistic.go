...
func StatsTableSqlSchema(dbName string) sql.PrimaryKeySchema {
	return sql.PrimaryKeySchema{
		Schema: sql.Schema{
			...
			&sql.Column{Name: StatsRowCountColName, Type: types.Uint64, DatabaseSource: dbName},
			&sql.Column{Name: StatsDistinctCountColName, Type: types.Uint64, DatabaseSource: dbName},
			&sql.Column{Name: StatsNullCountColName, Type: types.Uint64, DatabaseSource: dbName},
			...
			&sql.Column{Name: StatsUpperBoundCntColName, Type: types.Uint64, DatabaseSource: dbName},
