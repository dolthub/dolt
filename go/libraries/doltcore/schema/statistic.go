...
var StatsTableSqlSchema = sql.PrimaryKeySchema{
	Schema: sql.Schema{
		...
		&sql.Column{Name: StatsColumnsColName, Type: types.JSON},
		&sql.Column{Name: StatsTypesColName, Type: types.JSON},
		&sql.Column{Name: StatsUpperBoundColName, Type: types.JSON},
		&sql.Column{Name: StatsUpperBoundCntColName, Type: types.Int64},
		&sql.Column{Name: StatsCreatedAtColName, Type: types.Datetime},
		&sql.Column{Name: StatsMcv1ColName, Type: types.JSON},
		&sql.Column{Name: StatsMcv2ColName, Type: types.JSON},
		&sql.Column{Name: StatsMcv3ColName, Type: types.JSON},
		&sql.Column{Name: StatsMcv4ColName, Type: types.JSON},
		&sql.Column{Name: StatsMcvCountsColName, Type: types.JSON},
	},
	PkOrdinals: []int{0, 1},
}
