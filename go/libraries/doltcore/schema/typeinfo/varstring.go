...
var (
	...
	// StringSmallDefaultType is about 1k per row, 16 columns per table
	StringSmallDefaultType = &varStringType{gmstypes.MustCreateStringWithDefaults(sqltypes.VarChar, MaxVarcharLength/16)}
)
