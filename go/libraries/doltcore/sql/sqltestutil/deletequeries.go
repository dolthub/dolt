...
var BasicDeleteTests = []DeleteTest{
	...
	{
		Name:           "delete where last matches some =",
		DeleteQuery:    "delete from people where last = 'Simpson'",
		SelectQuery:    "select * from people",
		ExpectedRows:   CompressRows(PeopleTestSchema, Moe, Barney),
		ExpectedSchema: CompressSchema(PeopleTestSchema),
	},
	...
	{
		Name:           "delete where last matches some like",
		DeleteQuery:    "delete from people where last like '%pson'",
		SelectQuery:    "select * from people",
		ExpectedRows:   CompressRows(PeopleTestSchema, Moe, Barney),
		ExpectedSchema: CompressSchema(PeopleTestSchema),
	},
