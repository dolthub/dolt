...
func sqlSchemaNewColumn(name string, tableName string, typ sql.Type, isPrimaryKey, isNullable bool) *sql.Column {
	return &sql.Column{Name: name, Source: tableName, Type: typ, PrimaryKey: isPrimaryKey, Nullable: isNullable}
}
...
func sqlSchemaNewColumnWithDefault(name string, tableName string, typ sql.Type, isPrimaryKey, isNullable bool, expr sql.Expression, representsLiteral bool) *sql.Column {
	def := mustCreateDefault(expr, nil, representsLiteral, true)
	return &sql.Column{Name: name, Source: tableName, Type: typ, PrimaryKey: isPrimaryKey, Nullable: isNullable, Default: def}
}
