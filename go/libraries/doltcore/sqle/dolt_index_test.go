...
`)
	...
	indexMap := map[string]DoltIndex{
		"onepk:primaryKey": &doltIndex{
			...
			db:        db,
			id:        "onepk:primaryKey",
			indexRows: tableDataMap["onepk"],
			indexSch:  tableSchemaMap["onepk"],
			table:     tableMap["onepk"],
			tableRows: tableDataMap["onepk"],
			tableName: "onepk",
		...
		"twopk:primaryKey": &doltIndex{
			...
			db:        db,
			id:        "twopk:primaryKey",
			indexRows: tableDataMap["twopk"],
			indexSch:  tableSchemaMap["twopk"],
			table:     tableMap["twopk"],
			tableRows: tableDataMap["twopk"],
			tableName: "twopk",
		...
		"types:primaryKey": &doltIndex{
			...
			db:        db,
			id:        "types:primaryKey",
			indexRows: tableDataMap["types"],
			indexSch:  tableSchemaMap["types"],
			table:     tableMap["types"],
			tableRows: tableDataMap["types"],
			tableName: "types",
	...
	for _, indexDetails := range []struct {
		...
		indexMap[indexId] = &doltIndex{
			...
			tableRows: tableDataMap[indexDetails.tableName],
