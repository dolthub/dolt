...
var DoltProcedures = []sql.ExternalStoredProcedureDetails{
	...
	{Name: "dolt_merge", Schema: stringSchema("hash", "fast_forward", "conflicts"), Function: doltMerge},
	...
	{Name: "dmerge", Schema: stringSchema("hash", "fast_forward", "conflicts"), Function: doltMerge},
