...
func getSummaryForDelta(ctx *sql.Context, delta diff.TableDelta, sqledb dsess.VersionedDatabase, fromDetails, toDetails *refDetails, shouldErrorOnPKChange bool) (*diff.TableDeltaSummary, error) {
