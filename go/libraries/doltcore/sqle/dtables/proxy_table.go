...
func doltGlobalTablesSchema() sql.Schema {
	return []*sql.Column{
		...
		{Name: doltdb.GlobalTablesDBCol, Type: sqlTypes.VarChar, Source: doltdb.GetGlobalTablesTableName(), Nullable: true},
...
func NewGlobalTablesTable(_ *sql.Context, backingTable VersionableTable) sql.Table {
	return &BackedSystemTable{
		...
		tableName:    getDoltProxyTableName(),
...
func getDoltProxyTableName() doltdb.TableName {
