	...
	var scripts = []queries.ScriptTest{
		{
			...
			SetUpScript: []string{
				"create table parent (pk int primary key, i int, unique key (i));",
				"create table child (pk int primary key, j int, foreign key (j) references parent(i) on delete cascade on update cascade);",
				"insert into parent values (1, 1), (2, 2), (3, 3);",
				"insert into child values (1, 1), (2, 2), (3, 3);",
			},
			Assertions: []queries.ScriptTestAssertion{
				{
					Query: "update parent set i = i * 10;",
				},
				{
