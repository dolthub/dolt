...
func TestFilteredReader(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			genTwoIntPKRows(int64TupleGen(map[int64][]int64{0: {0, 1, 2, 3}, 1: {0}, 2: {4, 5}, 3: {0, 1}, 4: {7, 8, 9}, 5: {0, 1, 2, 3}, 6: {0}, 7: {4, 5}, 8: {0, 1}, 9: {7, 8, 9}, 10: {0, 1, 2, 3}, 11: {0}, 12: {4, 5}, 13: {0, 1}, 14: {7, 8, 9}})...),
			genTwoIntPKRows(int64TupleGen(map[int64][]int64{0: {0, 1, 2, 3}, 1: {0}, 2: {4, 5}, 3: {0, 1}, 4: {7, 8, 9}, 7: {4, 5}, 11: {0}, 12: {4, 5}, 13: {0, 1}, 14: {7, 8, 9}})...),
		},
	}
