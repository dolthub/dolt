	...
	tests := []struct {
	...
	}{
		{
			...
			expectedSchema: dtestutils.CreateSchema(
				schemaNewColumn(t, "id", 4817, types2.Int32, true, schema.NotNullConstraint{})),
		},
		{
			...
			expectedSchema: dtestutils.CreateSchema(
				schemaNewColumn(t, "id", 4817, types2.Int32, true, schema.NotNullConstraint{}),
				schemaNewColumn(t, "age", 7208, types2.Int32, false)),
		},
		{
			...
			expectedTable: "testTable",
			expectedSchema: dtestutils.CreateSchema(
				schemaNewColumn(t, "id", 4817, types2.Int32, false),
				schemaNewColumn(t, "age", 7208, types2.Int32, false)),
		},
		{
		...
		},
		{
			...
			expectedSchema: dtestutils.CreateSchema(
				schemaNewColumn(t, "id", 4817, types2.Int32, true, schema.NotNullConstraint{}),
				schemaNewColumn(t, "age", 7208, types2.Int32, false),
				schemaNewColumn(t, "first_name", 3264, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 255), false),
				schemaNewColumn(t, "is_married", 14626, types2.Boolean, false)),
		},
		{
			...
			query: `create table testTable (
							...
							c26 bigint unsigned)`,
			expectedSchema: dtestutils.CreateSchema(
				schemaNewColumn(t, "c0", 594, types2.Int32, true, schema.NotNullConstraint{}),
				schemaNewColumn(t, "c1", 601, types2.Int8, false),
				schemaNewColumn(t, "c2", 14542, types2.Int16, false),
				schemaNewColumn(t, "c3", 13309, types2.Int24, false),
				schemaNewColumn(t, "c4", 15884, types2.Int32, false),
				schemaNewColumn(t, "c5", 14619, types2.Int64, false),
				schemaNewColumn(t, "c6", 13192, types2.Boolean, false),
				schemaNewColumn(t, "c7", 5981, types2.Boolean, false),
				schemaNewColumn(t, "c8", 14871, types2.MustCreateBitType(10), false),
				schemaNewColumn(t, "c9", 4167, types2.Text, false),
				schemaNewColumn(t, "c10", 1965, types2.TinyText, false),
				schemaNewColumn(t, "c11", 12860, types2.MediumText, false),
				schemaNewColumn(t, "c12", 7155, types2.LongText, false),
				...
				schemaNewColumn(t, "c16", 15859, types2.MustCreateStringWithDefaults(sqltypes.Char, 5), false),
				schemaNewColumn(t, "c17", 11710, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 255), false),
				schemaNewColumn(t, "c18", 6838, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 80), false),
				schemaNewColumn(t, "c19", 9377, types2.Float32, false),
				schemaNewColumn(t, "c20", 15979, types2.Float64, false),
				//schemaNewColumn(t, "c21", 121, sql.MustCreateDecimalType(10, 5), false),
				schemaNewColumn(t, "c22", 2910, types2.Uint32, false),
				schemaNewColumn(t, "c23", 8740, types2.Uint8, false),
				schemaNewColumn(t, "c24", 8689, types2.Uint16, false),
				schemaNewColumn(t, "c25", 5243, types2.Uint24, false),
				schemaNewColumn(t, "c26", 9338, types2.Uint64, false),
			),
		},
		{
			...
			expectedSchema: dtestutils.CreateSchema(
				schemaNewColumn(t, "id", 4817, types2.Int32, true, schema.NotNullConstraint{}),
				schemaNewColumn(t, "age", 7208, types2.Int32, true, schema.NotNullConstraint{}),
				schemaNewColumn(t, "first_name", 3264, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 80), false),
				schemaNewColumn(t, "is_married", 14626, types2.Boolean, false)),
		},
		{
			...
			expectedSchema: dtestutils.CreateSchema(
				schemaNewColumn(t, "id", 4817, types2.Int32, true, schema.NotNullConstraint{}),
				schemaNewColumn(t, "age", 7208, types2.Int32, true, schema.NotNullConstraint{}),
				schemaNewColumn(t, "first_name", 3264, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 80), false, schema.NotNullConstraint{}),
				schemaNewColumn(t, "is_married", 14626, types2.Boolean, false)),
		},
		{
			...
			expectedSchema: dtestutils.CreateSchema(
				schemaNewColumn(t, "id", 4817, types2.Int32, true, schema.NotNullConstraint{}),
				schemaNewColumn(t, "age", 7208, types2.Int32, true, schema.NotNullConstraint{}),
				schemaNewColumn(t, "timestamp", 10168, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 80), false),
				schemaNewColumn(t, "is married", 14626, types2.Boolean, false)),
		},
		{
		...
		// Real world examples for regression testing
		{
			...
			expectedSchema: dtestutils.CreateSchema(
				schemaNewColumnWDefVal(t, "ip", 7265, types2.Uint32, true, "0", schema.NotNullConstraint{}),
				schemaNewColumnWDefVal(t, "country", 6630, types2.MustCreateStringWithDefaults(sqltypes.Char, 2), false, `''`, schema.NotNullConstraint{})),
		},
		{
			...
			query: `CREATE TABLE ip2nationCountries (
							...
							PRIMARY KEY (code));`,
			expectedSchema: dtestutils.CreateSchema(
				schemaNewColumnWDefVal(t, "code", 7802, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 4), true, `''`, schema.NotNullConstraint{}),
				schemaNewColumnWDefVal(t, "iso_code_2", 9266, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 2), false, `''`, schema.NotNullConstraint{}),
				schemaNewColumnWDefVal(t, "iso_code_3", 8427, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 3), false, `''`),
				schemaNewColumnWDefVal(t, "iso_country", 7151, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 255), false, `''`, schema.NotNullConstraint{}),
				schemaNewColumnWDefVal(t, "country", 879, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 255), false, `''`, schema.NotNullConstraint{}),
				schemaNewColumnWDefVal(t, "lat", 3502, types2.Float32, false, "0.0", schema.NotNullConstraint{}),
				schemaNewColumnWDefVal(t, "lon", 9907, types2.Float32, false, "0.0", schema.NotNullConstraint{})),
		},
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumn(t, "newColumn", 4208, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 80), false)),
		...
		},
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumn(t, "newColumn", 4208, types2.Float32, false)),
			expectedRows: addColToRows(t, AllPeopleRows, 4208, nil),
		},
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumn(t, "newColumn", 4208, types2.Uint64, false)),
			expectedRows: addColToRows(t, AllPeopleRows, 4208, nil),
		},
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumnWDefVal(t, "newColumn", 2803, types2.Int32, false, "2")),
		...
		},
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumnWDefVal(t, "newColumn", 517, types2.Uint64, false, "20")),
		...
		},
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumnWDefVal(t, "newColumn", 13690, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 80), false, `'hi'`)),
		...
		},
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumnWDefVal(t, "newColumn", 13690, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 80), false, `'default'`, schema.NotNullConstraint{})),
		...
		},
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumnWDefVal(t, "newColumn", 2803, types2.Int32, false, "((2 + (2 / 2)))", schema.NotNullConstraint{})),
		...
		},
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumnWDefVal(t, "newColumn", 12469, types2.Float32, false, "-1.1", schema.NotNullConstraint{})),
		...
		},
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumnWDefVal(t, "newColumn", 13690, types2.MustCreateStringWithDefaults(sqltypes.VarChar, 80), false, "", schema.NotNullConstraint{})),
		...
		},
		{
			...
			expectedSchema: dtestutils.AddColumnToSchema(PeopleTestSchema,
				schemaNewColumn(t, "newColumn", 4435, types2.Int64, false)),
