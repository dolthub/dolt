	...
	tests := []struct {
		...
		},
		{
			...
			bucket: DoltBucket{Bucket: &stats.Bucket{
				RowCnt:      15,
				DistinctCnt: 11,
				McvVals:     []sql.UntypedSqlRow{sql.UntypedSqlRow{int64(4), int64(1)}},
				McvsCnt:     []uint64{3},
		...
		},
		{
			...
			bucket: DoltBucket{Bucket: &stats.Bucket{
				RowCnt:      23,
				DistinctCnt: 18,
				McvVals:     []sql.UntypedSqlRow{sql.UntypedSqlRow{int64(10)}, sql.UntypedSqlRow{int64(7)}},
				McvsCnt:     []uint64{3, 4},
