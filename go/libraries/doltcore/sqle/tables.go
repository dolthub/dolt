...
func (p doltTablePartition) IteratorForPartition(ctx context.Context, m prolly.Map) (prolly.MapRangeIter, error) {
	panic("unimplemented")
}
...
func (p *partitionIter) Next(ctx context.Context) (k, v val.Tuple, err error) {
	if p.pos >= p.end {
