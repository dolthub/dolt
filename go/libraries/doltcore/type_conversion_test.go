...
func TestConv(t *testing.T) {
	tests := []struct {
		...
		{types.String(""), types.String(""), identityConvFunc, false},
		{types.String(""), types.NullValue, convStringToUUID, false},
		{types.String(""), types.NullValue, convStringToUint, false},
		{types.String(""), types.NullValue, convStringToInt, false},
		{types.String(""), types.NullValue, convStringToFloat, false},
		{types.String(""), types.NullValue, convStringToBool, false},
		{types.String(""), types.NullValue, convToNullFunc, false},
		{types.String("\"\""), types.String(""), identityConvFunc, false},
		{types.String("\"\""), types.NullValue, convStringToUUID, false},
		{types.String("\"\""), types.NullValue, convStringToUint, false},
		{types.String("\"\""), types.NullValue, convStringToInt, false},
