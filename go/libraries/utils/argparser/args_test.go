...
func TestParsing(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			exp := &ArgParseResults{options: test.expectedOpts, repeatedOptions: map[string][]string{}, Args: test.expectedArgs, parser: parser, PositionalArgsSeparatorIndex: NO_POSITIONAL_ARGS}
