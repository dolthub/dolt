...
type parentsClosureIter interface {
	...
	Hash() hash.Hash
	Height() uint64
	Less(ctx context.Context, vr types.ValueReader, itr parentsClosureIter) bool
...
func (i *parentsClosureIterator) Less(ctx context.Context, vr types.ValueReader, otherI parentsClosureIter) bool {
	other := otherI.(*parentsClosureIterator)
	if i.err != nil || other.err != nil {
		return false
	}
	ret, err := i.curr.Less(ctx, vr, other.curr)
	if err != nil {
		i.err = err
		other.err = err
		return false
...
func (i *fbParentsClosureIterator) Less(ctx context.Context, vr types.ValueReader, otherI parentsClosureIter) bool {
