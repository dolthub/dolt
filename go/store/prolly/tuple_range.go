...
func (r Range) KeyRangeLookup(pool pool.BuffPool) (val.Tuple, val.Tuple, bool) {
	if r.Tup == nil {
...
func IncrementTuple(start val.Tuple, n int, desc val.TupleDesc, pool pool.BuffPool) (val.Tuple, val.Tuple, bool) {
