...
var KindToString = map[NomsKind]string{
	...
	NullKind:            "Null",
	TupleKind:           "Tuple",
	UnderlyingArrayKind: "UnderlyingArray",
}
...
func IsPrimitiveKind(k NomsKind) bool {
	switch k {
	case BoolKind, FloatKind, IntKind, UintKind, StringKind, BlobKind, UUIDKind, ValueKind, TypeKind, NullKind, UnderlyingArrayKind:
		return true
	default:
		return false
	}
