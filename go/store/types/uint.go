...
func (v Uint) Equals(format *Format, other Value) bool {
	return v == other
}

func (v Uint) Less(f *Format, other LesserValuable) bool {
...
func (v Uint) Hash(f *Format) hash.Hash {
	return getHash(v, f)
}
...
func (v Uint) WalkRefs(f *Format, cb RefCallback) {
}
