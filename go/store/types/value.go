...
type Value interface {
	...
	// MarshalToKind takes in a Kind and returns a function that accepts a Value of the calling type.
	// The returned function then marshals the given type into the given Kind.
	MarshalToKind(NomsKind) MarshalCallback
...
// PrimitiveValue is the interface all primitive values implement.
type DoltValue interface {
	Value
}
