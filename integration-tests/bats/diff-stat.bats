...
@test "diff-stat: stat/summary comparing working table to last commit" {
    ...
    [[ "$output" =~ \|[[:space:]]+test[[:space:]]+\|[[:space:]]+modified[[:space:]]+\|[[:space:]]+1[[:space:]]+\|[[:space:]]+0[[:space:]]+\| ]] || false
...
@test "diff-stat: stat/summary comparing row with a deleted cell and an added cell" {
    ...
    [ "$status" -eq 0 ]
    [[ "$output" =~ "| Table name | Diff type | Data change | Schema change |" ]] || false
    [[ "$output" =~ \|[[:space:]]+test[[:space:]]+\|[[:space:]]+added[[:space:]]+\|[[:space:]]+0[[:space:]]+\|[[:space:]]+1[[:space:]]+\| ]] || false
...
DELIM
    ...
    [ "$status" -eq 0 ]
    [[ "$output" =~ "| Table name | Diff type | Data change | Schema change |" ]] || false
    [[ "$output" =~ \|[[:space:]]+employees[[:space:]]+\|[[:space:]]+modified[[:space:]]+\|[[:space:]]+1[[:space:]]+\|[[:space:]]+1[[:space:]]+\| ]] || false
...
SQL
    ...
    [[ "$output" =~ "| Table name | Diff type | Data change | Schema change |" ]] || false
    [[ "$output" =~ \|[[:space:]]+test[[:space:]]+\|[[:space:]]+modified[[:space:]]+\|[[:space:]]+1[[:space:]]+\|[[:space:]]+0[[:space:]]+\| ]] || false
    [[ "$output" =~ \|[[:space:]]+employees[[:space:]]+\|[[:space:]]+modified[[:space:]]+\|[[:space:]]+1[[:space:]]+\|[[:space:]]+0[[:space:]]+\| ]] || false
...
@test "diff-stat: stat/summary for renamed table" {
    ...
    [ "$status" -eq 0 ]
    [[ "$output" =~ "| Table name    | Diff type | Data change | Schema change |" ]] || false
    [[ "$output" =~ \|[[:space:]]+test[[:space:]]+\-\>[[:space:]]+test2[[:space:]]+\|[[:space:]]+renamed[[:space:]]+\|[[:space:]]+0[[:space:]]+\|[[:space:]]+1[[:space:]]+\| ]] || false
    ...
    [ "$status" -eq 0 ]
    [[ "$output" =~ "| Table name    | Diff type | Data change | Schema change |" ]] || false
    [[ "$output" =~ \|[[:space:]]+test[[:space:]]+\-\>[[:space:]]+test2[[:space:]]+\|[[:space:]]+renamed[[:space:]]+\|[[:space:]]+1[[:space:]]+\|[[:space:]]+1[[:space:]]+\| ]] || false
}