...
SQL
    ...
    [ "${lines[2]}" = "+------------+-----------+-------------+---------------+" ]
    [[ "${lines[3]}" =~ ^\|[[:space:]]+t1[[:space:]]+\|[[:space:]]+dropped[[:space:]]+\|[[:space:]]+(false|0)[[:space:]]+\|[[:space:]]+(true|1)[[:space:]]+\|$ ]] || false
    [[ "${lines[4]}" =~ ^\|[[:space:]]+t2[[:space:]]+\|[[:space:]]+modified[[:space:]]+\|[[:space:]]+(false|0)[[:space:]]+\|[[:space:]]+(true|1)[[:space:]]+\|$ ]] || false
    [[ "${lines[5]}" =~ ^\|[[:space:]]+t3[[:space:]]+\|[[:space:]]+modified[[:space:]]+\|[[:space:]]+(true|1)[[:space:]]+\|[[:space:]]+(false|0)[[:space:]]+\|$ ]] || false
    [[ "${lines[6]}" =~ ^\|[[:space:]]+t4[[:space:]]+\|[[:space:]]+added[[:space:]]+\|[[:space:]]+(false|0)[[:space:]]+\|[[:space:]]+(true|1)[[:space:]]+\|$ ]] || false
    [ "${lines[7]}" = "+------------+-----------+-------------+---------------+" ]
