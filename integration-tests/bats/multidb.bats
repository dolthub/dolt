...
@test "multidb: database default branches" {
    ...
    dolt sql-client -u -p -h -q repo1 1 dolt "" "create database new; use new; call dcheckout('-b', 'feat'); create table t (x int); call dolt_add('.'); call dcommit('-am', 'cm'); set @@global.new_default_branch='feat'"
    dolt sql-client -u -p -h -q repo1 1 dolt "" "use repo1"
}
