...
@test "replication-multidb: sql-server push on commit" {
    ...
    dolt sql-client -u -p -h -q repo1 1 dolt "" "create table t1 (a int primary key)"
    dolt sql-client -u -p -h -q repo1 1 dolt "" "call dolt_add('.')"
    dolt sql-client -u -p -h -q repo1 1 dolt "" "call dolt_commit('-am', 'cm')"
    dolt sql-client -u -p -h -q repo2 1 dolt "" "create table t2 (a int primary key)"
    dolt sql-client -u -p -h -q repo2 1 dolt "" "call dolt_add('.')"
    dolt sql-client -u -p -h -q repo2 1 dolt  "" "call dolt_commit('-am', 'cm')"
    dolt sql-client -u -p -h -q repo3 1 dolt "" "create table t3 (a int primary key)"
    dolt sql-client -u -p -h -q repo3 1 dolt "" "call dolt_add('.')"
    dolt sql-client -u -p -h -q repo3 1 dolt "" "call dolt_commit('-am', 'cm')"
...
@test "replication-multidb: sql-server pull on read" {
    ...
    dolt sql-client -u -p -h -q repo3 1 dolt "" "show tables" "Tables_in_repo3\nt3"
}
