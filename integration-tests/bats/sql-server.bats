...
@test "sql-server: dirty branches listed properly in dolt_branches table" {
    ...
    [ "$status" -eq 0 ]
    [[ "$output" =~ br1[[:space:]]+\|[[:space:]]+(false|0)[[:space:]]+\| ]] || false
    [[ "$output" =~ br2[[:space:]]+\|[[:space:]]+(true|1)[[:space:]]+\| ]] || false
    [[ "$output" =~ br3[[:space:]]+\|[[:space:]]+(true|1)[[:space:]]+\| ]] || false
    [[ "$output" =~ main[[:space:]]+\|[[:space:]]+(false|0)[[:space:]]+\| ]] || false
