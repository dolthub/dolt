...
import type {Splice, EqualsFn} from './edit_distance.js';
...
suite('Edit Distance', () => {
  ...
  function assertDiff<T>(eqFn: EqualsFn<T>, current: Array<T>, last: Array<T>,
    expect: Array<Splice>) {
    assert.deepEqual(calcSplices(eqFn, current, last), expect);
  }
